...
IMPLEMENT_DYNAMIC(CPhase, CDialogEx)

CPhase::CPhase(CWnd* pParent /*=NULL*/)
	: CDialogEx(CPhase::IDD, pParent)
{
...
void CPhase::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CPhase, CDialogEx)
	ON_WM_PAINT()
END_MESSAGE_MAP()
...
void CPhase::setDara(vector<double>* data)
{
	m_data = data;

}

void CPhase::updateshow()
{
	Invalidate();
}
