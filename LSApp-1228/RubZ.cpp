...
IMPLEMENT_DYNAMIC(CRubZ, CDialogEx)

CRubZ::CRubZ(CWnd* pParent /*=NULL*/)
	: CDialogEx(CRubZ::IDD, pParent)
{
...
void CRubZ::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CRubZ, CDialogEx)
	ON_WM_PAINT()
END_MESSAGE_MAP()
...
void CRubZ::setDara(vector<double>* data)
{
	m_data = data;

}

void CRubZ::updateshow()
{
	Invalidate();
}
