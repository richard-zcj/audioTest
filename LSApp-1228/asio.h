...
extern "C" _declspec (dllexport) ASIOError ASIOGetChannelInfo(ASIOChannelInfo *info);
/* Purpose:
...
extern "C" _declspec (dllexport) ASIOError ASIOControlPanel(void);
/* Purpose:
...
struct OutputPortItem
{
	void* buffer_ori;
	void* buffer_play;
	void* buffer_next;
	char* readptr;
	int buffer_len_current;
	int buffer_len_next;
	int processed_buf_size;
	bool playback_done;
};

struct InputPortItem
{
	char* buffer;
	char* buffer_debug;
	int remained_samples;
	bool capture_done;
	char* buffer_ori;
	char* buffer_debug_ori;
	int totalLen;
};

/*
extern "C" _declspec (dllexport) bool loadAsioDriver(char *name);
extern "C" _declspec (dllexport) void releaseAsioDriver();
extern "C" _declspec (dllexport) int getAsioDriverCount();
extern "C" _declspec (dllexport) long getAsioDriverName(int index, char *name);
extern "C" _declspec (dllexport) ASIOError Initialize();
extern "C" _declspec (dllexport) long GetBufferSizeMin();
extern "C" _declspec (dllexport) long GetBufferSizeMax();
extern "C" _declspec (dllexport) long GetBufferSizePreferred();
extern "C" _declspec (dllexport) ASIOError SetSampleRate(ASIOSampleRate rate);
extern "C" _declspec (dllexport) ASIOError Prepare();
extern "C" _declspec (dllexport) long GetInputChannelCount();
extern "C" _declspec (dllexport) long GetOutputChannelCount();
extern "C" _declspec (dllexport) ASIOSampleRate GetCurrentSampleRate();
extern "C" _declspec (dllexport) ASIOError PlayBuff(BufferInfo bufferList[], int length);
extern "C" _declspec (dllexport) ASIOError CaptureBuff(BufferInfo bufferList[], int length);
extern "C" _declspec (dllexport) void StopPlayback();
extern "C" _declspec (dllexport) void StopCapture();
extern "C" _declspec (dllexport) ASIOError Finish();
extern "C" _declspec (dllexport) long GetInputLatency();
extern "C" _declspec (dllexport) long GetOutputLatency();
extern "C" _declspec (dllexport) bool IsCaptureRunning();
extern "C" _declspec (dllexport) bool IsRscardInsert();
extern "C" _declspec (dllexport) ASIOError SetPlayBuffer(void* buffer, int len, int port);
extern "C" _declspec (dllexport) ASIOError SetCaptureBuffer(void* buffer, int len, int port);
extern "C" _declspec (dllexport) void StartPlayback();
extern "C" _declspec (dllexport) void StartCapture();
extern "C" _declspec (dllexport) bool IsPortCaptureRunning(int port);
extern "C" _declspec (dllexport) bool IsPortPlaybackRunning(int port);
*/
