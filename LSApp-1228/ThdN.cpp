...
IMPLEMENT_DYNAMIC(CThdN, CDialogEx)

CThdN::CThdN(CWnd* pParent /*=NULL*/)
	: CDialogEx(CThdN::IDD, pParent)
{
...
void CThdN::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CThdN, CDialogEx)
	ON_WM_PAINT()
END_MESSAGE_MAP()
...
void CThdN::setDara(vector<double>* data)
{
	m_data = data;

}

void CThdN::updateshow()
{
	Invalidate();
}
