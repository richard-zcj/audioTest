...
IMPLEMENT_DYNAMIC(CFrTest, CDialogEx)

CFrTest::CFrTest(CWnd* pParent /*=NULL*/)
: CDialogEx(CFrTest::IDD, pParent), m_data(NULL)
{
...
void CFrTest::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CFrTest, CDialogEx)
	ON_WM_PAINT()
END_MESSAGE_MAP()
...
void CFrTest::setDara(vector<double>* data)
{
	m_data = data;
	
}

void CFrTest::updateshow()
{
	Invalidate();
}
